'''
The same as decentralplannerlocal_OnlineExpert_GAT.py
but saves GSO during prediction. This facility is for visualising graph attentions in analysis
'''
...
class DecentralPlannerAgentLocalWithOnlineExpertGATLoadOEReturnGSO(BaseAgent):
    ...
    def __init__(self, config):
        ...
        if not self.config.batch_numAgent:
            ...
            if self.config.bottleneckMode == 'BottomNeck_only':
                ...
                from graphs.models.decentralplanner_GAT_bottleneck_SkipConcatGNN_returnAttentionGSO import DecentralPlannerGATNet
                ...
                from graphs.models.decentralplanner_GAT_returnAttentionGSO import DecentralPlannerGATNet
        ...
        while True:
            ...
            try:
                ...
                for step in range(maxstep):
                    ...
                    if config.return_attentionGSO:
                        attentionGSO = model.returnAttentionGSO()
                        thread_robot.record_attentionGSO(attentionGSO)
