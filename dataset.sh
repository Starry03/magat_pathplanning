...
python CasesSolver_cropfromMap_fixedLength.py --loadmap_TYPE \
    ...
    --path_save ${SOLUTIONS_FOLDER} --path_loadSourceMap ${MAP_FOLDER}

python DataGen_Transformer_split_IDMap.py  --num_agents ${NUM_AGENTS} --map_w ${MAP_SIZE} \
    --map_density ${MAP_DENSITY}   --div_train 21000 --div_valid 4500 --div_test 4500 \
    --div_train_IDMap 0 --div_test_IDMap 427 --div_valid_IDMap 800 \
